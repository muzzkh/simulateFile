...
def main():
    log_file_path = './watchLogs/normal_time_watch.log'  # Update this with the actual path to your log file
    json_objects = parse_log_file(log_file_path)

    # Write the generated JSON objects to a JSON file
    output_file_path = './watchLogs/output_normal.json'  # Update this with the desired output file path
    with open(output_file_path, 'w') as output_file:
        json.dump(json_objects, output_file, indent=2)

    print("Parsed " + log_file_path + " and placed JSON file to: " + output_file_path)
